...
export const INITIAL_GRADES: GradeRecord[] = [
  // Semester 4: Spring 2026 (12 Credits)
  {
    id: 'grd-1',
    studentId: 'usr-student-1',
    courseId: 'crs-theo-201',
    courseCode: 'THE-201',
    courseTitle: 'Systematic Theology I: Doctrine of God & Scripture',
    creditHours: 3,
  ...
  },
  {
    id: 'grd-4',
    studentId: 'usr-student-1',
    courseId: 'crs-gre-102',
    courseCode: 'GRE-102',
    courseTitle: 'Biblical Greek II: Syntax & Exegetical Method',
    creditHours: 3,
    semester: 'Spring 2026',
    year: 2026,
    assignmentScore: 97,
  ...
  },
  {
    id: 'grd-5',
    studentId: 'usr-student-1',
    courseId: 'crs-eth-301',
    courseCode: 'ETH-301',
    courseTitle: 'Christian Ethics & Ministerial Integrity',
    creditHours: 3,
    semester: 'Spring 2026',
    year: 2026,
    assignmentScore: 95,
    ...
    letterGrade: 'A',
    gradePoint: 4.0,
    instructorName: 'Dr. Carolyn Perez, Ed.D.',
    schoolName: 'School of Christian Leadership',
    status: 'Completed',
    qualityPoints: 12.0
  },

  // Semester 3: Fall 2025 (12 Credits)
  {
    id: 'grd-3',
    studentId: 'usr-student-1',
    courseId: 'crs-miss-302',
    ...
    gradePoint: 4.0,
    instructorName: 'Dr. Samuel Boateng, D.Miss.',
    schoolName: 'School of Missions and Evangelism',
    status: 'Completed',
    qualityPoints: 12.0
  },
  {
  ...
  },
  {
    ...
    courseCode: 'GRE-101',
    courseTitle: 'Biblical Greek I: Grammar & Vocabulary Foundations',
    creditHours: 3,
    semester: 'Fall 2025',
    year: 2025,
    assignmentScore: 92,
  ...
  },
  {
    id: 'grd-8',
    studentId: 'usr-student-1',
    courseId: 'crs-his-202',
    courseCode: 'HIS-202',
    courseTitle: 'Global Church History II: Reformation to Modern Era',
    creditHours: 3,
    semester: 'Fall 2025',
    year: 2025,
    assignmentScore: 94,
  ...
  // Semester 2: Spring 2025 (12 Credits)
  {
    id: 'grd-9',
    studentId: 'usr-student-1',
    courseId: 'crs-theo-102',
    courseCode: 'THE-102',
    courseTitle: 'Systematic Theology II: Christology, Soteriology & Pneumatology',
    creditHours: 3,
  ...
  },
  {
    id: 'grd-10',
    studentId: 'usr-student-1',
    courseId: 'crs-his-201',
    courseCode: 'HIS-201',
    courseTitle: 'Global Church History I: Patristic & Medieval Period',
    creditHours: 3,
    semester: 'Spring 2025',
    year: 2025,
    assignmentScore: 89,
  ...
  },
  {
    id: 'grd-11',
    studentId: 'usr-student-1',
    courseId: 'crs-bib-202',
    courseCode: 'BIB-202',
    courseTitle: 'Old Testament Survey: Law, Prophets & Writings',
    creditHours: 3,
    semester: 'Spring 2025',
    year: 2025,
    assignmentScore: 94,
  ...
  },
  {
    id: 'grd-12',
    studentId: 'usr-student-1',
    courseId: 'crs-min-201',
    courseCode: 'MIN-201',
    courseTitle: 'Evangelism, Discipleship & Spiritual Multiplication',
    creditHours: 3,
    semester: 'Spring 2025',
    year: 2025,
    assignmentScore: 95,
  ...
  // Semester 1: Fall 2024 (12 Credits)
  {
    id: 'grd-13',
    studentId: 'usr-student-1',
    courseId: 'crs-bib-101',
    courseCode: 'BIB-101',
    courseTitle: 'New Testament Survey: Gospels, Acts & Pauline Epistles',
    creditHours: 3,
    semester: 'Fall 2024',
    year: 2024,
    assignmentScore: 97,
  ...
  },
  {
    id: 'grd-14',
    studentId: 'usr-student-1',
    courseId: 'crs-theo-101',
    courseCode: 'THE-101',
    courseTitle: 'Introduction to Christian Dogmatics & Bibliology',
    creditHours: 3,
    semester: 'Fall 2024',
    year: 2024,
    assignmentScore: 95,
  ...
  },
  {
    id: 'grd-15',
    studentId: 'usr-student-1',
    courseId: 'crs-apo-201',
    courseCode: 'APO-201',
    courseTitle: 'Christian Apologetics & Contemporary Worldviews',
    creditHours: 3,
    semester: 'Fall 2024',
    year: 2024,
    assignmentScore: 91,
    ...
    letterGrade: 'A-',
    gradePoint: 3.7,
    instructorName: 'Dr. Deborah K. Alverez, D.Min.',
    schoolName: 'School of Theology & Apologetics',
    status: 'Completed',
    qualityPoints: 11.1
  },
  {
    id: 'grd-16',
    studentId: 'usr-student-1',
    courseId: 'crs-min-101',
    courseCode: 'MIN-101',
    courseTitle: 'Spiritual Formation, Prayer & Contemplative Disciplines',
    creditHours: 3,
    semester: 'Fall 2024',
    year: 2024,
    assignmentScore: 99,
